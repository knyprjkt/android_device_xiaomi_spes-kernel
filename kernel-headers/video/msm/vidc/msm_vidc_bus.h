...
static __inline__ u32 get_type_frm_name(char *name)
{
...
static __inline__ bool __ubwc(enum hal_uncompressed_format f)
{
	switch (f) {
...
static __inline__ int __bpp(enum hal_uncompressed_format f, u32 sid)
{
	switch (f) {
