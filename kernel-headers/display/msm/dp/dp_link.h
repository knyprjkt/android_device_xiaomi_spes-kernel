...
static __inline__ char *dp_link_get_test_name(u32 test_requested)
{
...
static __inline__ char *dp_link_get_phy_test_pattern(u32 phy_test_pattern_sel)
{
 ...
 */
static __inline__ u32 dp_link_bit_depth_to_bpp(u32 tbd)
{
	u32 bpp;
