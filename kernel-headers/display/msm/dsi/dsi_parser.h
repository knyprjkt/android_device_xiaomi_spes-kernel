...
static __inline__ void *dsi_parser_get(struct device *dev)
{
	return NULL;
}

static __inline__ void dsi_parser_put(void *data)
{
}

static __inline__ int dsi_parser_dbg_init(void *parser, struct dentry *dir)
{
	return -ENODEV;
}

static __inline__ void *dsi_parser_get_head_node(void *parser,
		const u8 *data, u32 size)
{
	return NULL;
}

static __inline__ const void *dsi_parser_get_property(const struct device_node *np,
			const char *name, int *lenp)
{
	return NULL;
}

static __inline__ bool dsi_parser_read_bool(const struct device_node *np,
			const char *propname)
{
	return false;
}

static __inline__ int dsi_parser_read_u64(const struct device_node *np,
			const char *propname, u64 *out_value)
{
	return -ENODEV;
}

static __inline__ int dsi_parser_read_u32(const struct device_node *np,
			const char *propname, u32 *out_value)
{
	return -ENODEV;
}

static __inline__ int dsi_parser_read_u32_array(const struct device_node *np,
			const char *propname, u32 *out_values, size_t sz)
{
	return -ENODEV;
}

static __inline__ int dsi_parser_read_string(const struct device_node *np,
			const char *propname, const char **out_string)
{
	return -ENODEV;
}

static __inline__ struct device_node *dsi_parser_get_child_by_name(
...
static __inline__ int dsi_parser_get_child_count(const struct device_node *np)
{
	return -ENODEV;
}

static __inline__ struct property *dsi_parser_find_property(
...
static __inline__ struct device_node *dsi_parser_get_next_child(
				const struct device_node *np,
				struct device_node *prev)
{
	return NULL;
...
static __inline__ int dsi_parser_count_u32_elems(const struct device_node *np,
				const char *propname)
{
	return -ENODEV;
}

static __inline__ int dsi_parser_count_strings(const struct device_node *np,
			    const char *propname)
{
	return -ENODEV;
}

static __inline__ int dsi_parser_read_string_index(const struct device_node *np,
				const char *propname,
				int index, const char **output)
{
	return -ENODEV;
...
static __inline__ int dsi_parser_get_named_gpio(struct device_node *np,
				const char *propname, int index)
{
	return -ENODEV;
}
...
static __inline__ struct dsi_parser_utils *dsi_parser_get_of_utils(void)
{
...
static __inline__ struct dsi_parser_utils *dsi_parser_get_parser_utils(void)
{
