...
struct sde_hw_sspp_ops {
	...
	/**
	 * setup_pre_downscale - setup pre-downscaler for __inline__ rotation
	 * @ctx: Pointer to pipe context
 ...
 */
static __inline__ struct sde_hw_pipe *to_sde_hw_pipe(struct sde_hw_blk *hw)
{
...
struct sde_hw_pipe *sde_hw_sspp_init(enum sde_sspp idx,
		void *addr, struct sde_mdss_cfg *catalog,
