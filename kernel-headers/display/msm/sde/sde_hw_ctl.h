...
/**
 * sde_ctl_rot_op_mode - __inline__ rotation mode
 * SDE_CTL_ROT_OP_MODE_OFFLINE: offline rotation
 * SDE_CTL_ROT_OP_MODE_RESERVED: reserved
 * SDE_CTL_ROT_OP_MODE_INLINE_SYNC: __inline__ rotation synchronous mode
 * SDE_CTL_ROT_OP_MODE_INLINE_ASYNC: __inline__ rotation asynchronous mode
 */
 ...
 */
static __inline__ struct sde_hw_ctl *to_sde_hw_ctl(struct sde_hw_blk *hw)
{
