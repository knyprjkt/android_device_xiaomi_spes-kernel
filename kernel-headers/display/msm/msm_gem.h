...
static __inline__ bool is_active(struct msm_gem_object *msm_obj)
{
	return msm_obj->gpu != NULL;
}

static __inline__ bool is_purgeable(struct msm_gem_object *msm_obj)
{
...
static __inline__ bool is_vunmapable(struct msm_gem_object *msm_obj)
{
