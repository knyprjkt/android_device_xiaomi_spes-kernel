...
struct mdss_pll_resources {
	...
	void *phy_base;
	void *ln_tx0_base;
	void *ln_tx0_tran_base;
	void *ln_tx0_vmode_base;
	void *ln_tx1_base;
	void *ln_tx1_tran_base;
	void *ln_tx1_vmode_base;
	void *gdsc_base;
	void *dyn_pll_base;
...
static __inline__ bool is_gdsc_disabled(struct mdss_pll_resources *pll_res)
{
...
static __inline__ int mdss_pll_div_prepare(struct clk_hw *hw)
{
...
static __inline__ int mdss_set_mux_sel(void *context, unsigned int reg,
					unsigned int val)
{
	return 0;
}

static __inline__ int mdss_get_mux_sel(void *context, unsigned int reg,
					unsigned int *val)
{
	*val = 0;
	return 0;
