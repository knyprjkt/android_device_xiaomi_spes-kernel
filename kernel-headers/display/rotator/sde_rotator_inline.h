...
/*
 * enum sde_rotator_inline_cmd_type - __inline__ rotator command stages
 * @SDE_ROTATOR_INLINE_CMD_VALIDATE: validate command only
 * @SDE_ROTATOR_INLINE_CMD_COMMIT: commit command to hardware
 * @SDE_ROTATOR_INLINE_CMD_START: ready to start __inline__ rotation
...
/**
 * sde_rotator_inline_cmd - __inline__ rotation command
