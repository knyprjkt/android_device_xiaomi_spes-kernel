...
struct sde_hw_rotator {
	...
	/* Cmd Queue Write Ptr */
	char *cmd_wr_ptr[ROT_QUEUE_MAX][SDE_HW_ROT_REGDMA_TOTAL_CTX];
 ...
 */
static __inline__ u32 sde_hw_rotator_get_regdma_ctxidx(
		struct sde_hw_rotator_context *ctx)
{
 ...
 */
static __inline__ char *sde_hw_rotator_get_regdma_segment_base(
		struct sde_hw_rotator_context *ctx)
{
 ...
 */
static __inline__ char *sde_hw_rotator_get_regdma_segment(
		struct sde_hw_rotator_context *ctx)
{
	u32 idx = sde_hw_rotator_get_regdma_ctxidx(ctx);
	char *addr = ctx->regdma_wrptr;
 ...
 */
static __inline__ void sde_hw_rotator_put_regdma_segment(
		struct sde_hw_rotator_context *ctx,
		char *wrptr)
{
	u32 idx = sde_hw_rotator_get_regdma_ctxidx(ctx);
 ...
 * timestamp.
 */
static __inline__ void sde_hw_rotator_put_ctx(struct sde_hw_rotator_context *ctx)
{
 ...
 * timestamp.
 */
static __inline__ void sde_hw_rotator_clr_ctx(struct sde_hw_rotator_context *ctx)
{
	struct sde_hw_rotator *rot = ctx->rot;
	u32 idx = sde_hw_rotator_get_regdma_ctxidx(ctx);
	unsigned long flags;
